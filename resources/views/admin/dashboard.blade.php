...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <div class="jumbotron">
                    <p><span class="label label-primary">Категорий: {{$categories->count()}}</span></p>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="jumbotron">
                    <p><span class="label label-primary">Материалов: {{$articles->count()}}</span></p>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="jumbotron">
            ...
            <div class="col-sm-6">
                ...
                @foreach($categories as $category)
                    <a href="{{route('admin.category.edit', $category)}}" class="list-group-item">
                        ...
                        <p class="list-group-item-text">Новостей: {{$category->articles()->count()}}</p>
                    </a>
                @endforeach
            </div>
            <div class="col-sm-6">
